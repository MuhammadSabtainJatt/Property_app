            ...
            <div class="card">
                ...
                <div class="card-body" style="height: 549px;">
                    ...
                    <div class="col-md-12 col-12 form-group mandatory">
                        ...
                        {{ Form::textarea('description', isset($list->description) ? $list->description : '', ['class' => 'form-control mb-3', 'rows' => '3', 'id' => '', 'required' => 'true']) }}
                ...
                <div class="row card-body">
                    <div class="col-md-6 col-sm-12 form-group mandatory">
                        ...
                        <textarea id="edit_meta_title" name="edit_meta_title" class="form-control"
                            oninput="getWordCount('edit_meta_title','edit_meta_title_count','12.9px arial')" rows="2" required
                            style="height: 75px">{{ $list->meta_title }}</textarea>

                        <br>
                        <h6 id="edit_meta_title_count">0</h6>
                    </div>
                    <div class="col-md-4 col-sm-12 form-group mandatory card">
                    ...
                    <div class="col-md-12 col-sm-12 form-group mandatory">
                        ...
                        <textarea id="edit_meta_description" name="edit_meta_description" class="form-control"
                            oninput="getWordCount('edit_meta_description','edit_meta_description_count','12.9px arial')" rows="3">{{ $list->meta_description }}</textarea>
                        <br>
                    ...
                    <div class="col-md-12 col-sm-12 form-group mandatory">
                        ...
                        <textarea name="Keywords" id="" class="form-control" rows="3" required>{{ $list->meta_keywords }}</textarea>
                    ...
                    @foreach ($edit_parameters as $res)
                        <div class="col-md-3 form-group">
                            ...
                            @if ($res->type_of_parameter == 'dropdown')
                                <select name="{{ $res->id }}" class="choosen-select form-select form-control-sm"
                            ...
                            @if ($res->type_of_parameter == 'textarea')
                                <textarea name="{{ $res->id }}" id="" cols="30" rows="3"
