                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mandatory row mt-3">
                                        ...
                                        <label class="col-sm-1 form-label-mandatory ">{{ __('Link') }}</label>
                                        <div class="col-sm-11 col-md-10 col-xs-12">
                                            ...
                                            <input type="hidden" name="iframe_link" id="iframe_link"
                                                value="{{ system_setting('iframe_link') != '' ? system_setting('iframe_link') : '' }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="playstore_id" type="text" class="form-control"
                                                        ...
                                                        value="{{ system_setting('playstore_id') != '' ? system_setting('playstore_id') : '' }}">
                                            ...
                                            <div class="form-group  row mt-2">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label
                                                        class="col-sm-12 form-label mt-1">{{ __('Appstore Id') }}</label>

                                                    <input name="appstore_id" type="text" class="form-control"
                                                        placeholder="Appstore Id"
                                                        value="{{ system_setting('appstore_id') != '' ? system_setting('appstore_id') : '' }}">
                                                </div>
